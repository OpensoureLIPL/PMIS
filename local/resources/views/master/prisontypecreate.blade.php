    	  ...
    	  <h2>{{$title}}</h2>
    	 	...
    	 	<div class="col-md-12 compose-right">
					<div class="inbox-details-default">
                        ...
                        {!! Form::model($prisonType, ['action' => 'MasterController@prisonTypeSave']) !!}
                            {!! Form::hidden('id', null, []) !!}
                            <div class="form-group">
                                {!! Form::label('name', 'Name') !!}
                                {!! Form::text('title', null, ['class' => 'form-control alpha']) !!}
                            </div>
                            {!! Form::submit('Save', ['name' => 'submit','class'=>'btn btn-success']) !!}
                                <a href="{{asset('/')}}prisontypelist" class="btn btn-primary">Cancel</a>
