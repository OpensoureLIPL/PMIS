    	  ...
    	  <h2>{{$title}}</h2>
    	 	...
    	 	<div class="col-md-12 compose-right">
					<div class="inbox-details-default">
                        ...
                        {!! Form::model($prisonerType, ['action' => 'MasterController@prisonerTypeSave']) !!}
                            {!! Form::hidden('id', null, []) !!}
                            <div class="form-group">
                                {!! Form::label('name', 'Prisoner Type Name') !!}
                                {!! Form::text('name', null, ['class' => 'form-control alpha']) !!}
                            </div>
                            {!! Form::submit('Save', ['name' => 'submit','class'=>'btn btn-success']) !!}
                                <a href="{{asset('/')}}prisonertypelist" class="btn btn-primary">Cancel</a>
